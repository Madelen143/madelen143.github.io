...
function setBackgroundColor(color) {
    ...
    var containterToChange = document.getElementById("q1-container");
    // in CSS the selector is background-color but when referencing it becomes camelCase instead of Kabob
    containterToChange.style.backgroundColor = color;
