...
function closeLightbox(lightboxID) {
	...
	// Do not write code: if object  ! contains("attr") => add.("attr")
	// simply write add("attr") without checking
	// both contains() and add() have same code, and if adding duplicate through add,
	// the code handles so only one instance of that class remains since the classList is a set
	// set = collecton of unique items (no duplicates)
